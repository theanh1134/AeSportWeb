        ...
        <div class="row">
            ...
            <div class="col-11">
                <div class="container mt-5 ">
                    <h1 class=" my-4 ">Quản lí Sản Phẩm Sale</h1>
                    <div id="sale_product" class="row alert alert-secondary flex-wrap py-5 justify-content-center">

                        <c:forEach items="${requestScope.productsSaleHomePage}" var="pro">
                            <div class="card text-center bg-white shadow m-2" style="width: 18rem">
                                <span  class="  z-1 position-absolute p-2 m-2 rounded-5 text-white bg-danger top-0 end-0 ">-${pro.getDiscount().getDiscount_Amount()}%</span>
                                <img
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="text-danger my-2">
                                        ${Math.round((pro.getPrice() / 100) * (100-pro.getDiscount().getDiscount_Amount()))} đ
                                    </h4>
                                    ...
                                    <a href="ManageSaleProductHomePage?type=2&productID=${pro.productID}">
                    ...
                    <h3>Lọc Sản Phẩm</h3>
                    <div id="menu" >
                        <form class="form" action="ManageSaleProductHomePage" method="post">
                            <div class="d-flex">
                                ...
                                <c:if test="${ not empty requestScope.listCA}" >
                                    ...
                                    <button class=" float-end animated-button" name="checkProducts"  type="submit"  value="true">
                    ...
                    <c:if test="${not empty requestScope.products}">
                        <table class="table table-bordered table-hover table-dark table-striped rounded mt-5 transition-table ">
                            <thead>
                                <tr>
                            ...
                            <tbody class="table-group-divider table-divider-color">
                                <c:forEach items="${requestScope.products}" var="p">
                                    <tr class="p-3 text-center ">
                                        ...
                                        <td class="text-center">-${p.getDiscount().getDiscount_Amount()}% </td>
                                ...
                                <td class="text-center">
                                    <a href="ManageSaleProductHomePage?type=1&productID=${p.productID}&select1=${selectedValue}&category=${selectedCategory}&Subcategory=${Subcategory}" 
                                       class="btn btn-outline-primary">Thêm</a></td>
                                </tr>
                            </c:forEach>
