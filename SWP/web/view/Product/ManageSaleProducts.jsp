<%-- 
    Document   : ManageSaleProducts
    Created on : Jun 27, 2024, 6:01:39 PM
    Author     : Hoàng Sơn
--%>
        ...
        <div class="row">
            ...
            <div class="col-11">
                <div class="mt-5 w-75 container">
                    <h1 class="my-4">Tất Cả Sản Phẩm Sale</h1>
                    ...
                    <div id="menu">
                        <form class="form" action="ManageSaleProducts" method="post">
                            <div class="d-flex">
                            ...
                            <c:forEach items="${requestScope.products}" var="pro">
                                <div class="card text-center bg-white shadow m-2" style="width: 18rem">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button class=" button2 button   float-end " data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                            <i class="bi bi-plus-circle-dotted svgIcon text-light text-center"></i>
                                        </button>

                                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="ManageSaleProducts" method="post">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Thêm % Giảm cho sản phẩm <span class="text-danger">   ${ pro.getProductName()}</span> </h1>
