 ...
 * @author Admin
 */
public class ProductBySport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int Sport_ID = Integer.parseInt(sportid);
        List<Product1> products = prodao.getbysport(Sport_ID);
        List<SubCategory> subcategory = prodao.getAllsubcategory();
        List<sport> sport = prodao.getAllsport();
        ...
        request.setAttribute("listsport", sport);
